...
public class UserController {
  ...
  public String update(@PathVariable Long id, @Valid Users user, BindingResult bindingResult, Model model, Log log) {
    ...
    // Log the action
    int userId = Math.toIntExact(SessionManager.getUsers().getId());
    log.setUser_id(userId);
    log.setTimestamp(new Timestamp(System.currentTimeMillis()));
    log.setAction("url /update/" + id);
    log.setNotes("Old data: " + oldName + " | " + oldPassword + " Updated data: " + user.getName() + " | " + user.getPassword());
    logRepository.save(log);
